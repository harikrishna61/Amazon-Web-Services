...
def upload():
    ...
    if type=='txt' and fname_list[1]=='txt':
        ...
        return render_template("index_s3.html",msg="File uploaded successfully")
        ...
        return render_template("index_s3.html",msg="Type Mismatch")
...
def listfiles():
    ...
    return render_template("index_s3.html",fileslist=fileslist)
